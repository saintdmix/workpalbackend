              ...
              'items': <String, dynamic>{
                ...
                'items': <String, dynamic>{
                  ...
                  'properties': <String, dynamic>{
                    ...
                    'artisanName': <String, dynamic>{'type': 'string'},
                    'artisanUsername': <String, dynamic>{'type': 'string'},
                    'artisanImage': <String, dynamic>{'type': 'string'},
                    'artisanTitle': <String, dynamic>{'type': 'string'},
                    'artisanRating': <String, dynamic>{'type': 'number'},
                    'latitude': <String, dynamic>{'type': 'number'},
                    'longitude': <String, dynamic>{'type': 'number'},
                  },
                  'additionalProperties': true,
    ...
    '/workfeeds/{post_id}/save': <String, dynamic>{
      ...
      '/jobs': <String, dynamic>{
        ...
        'post': _operation(
          ...
          requestBodyDescription:
              'Job post payload. Accepts JSON or multipart/form-data (for image uploads).',
          requestBodyContent: <String, dynamic>{
            'application/json': <String, dynamic>{
              'schema': _objectSchema(
                properties: <String, dynamic>{
                  ...
                  'projectImageUrls': <String, dynamic>{
                    'type': 'array',
                    'items': <String, dynamic>{'type': 'string'},
                    'description': 'Alias for refImages.',
                  },
              ...
              'example': <String, dynamic>{
                ...
                'category': 'carpentry',
                'description':
                    'Install custom cabinets in a 3-bedroom apartment.',
                'budgetMin': 120000,
                'budgetMax': 250000,
                'isUrgent': true,
                'isRemote': false,
