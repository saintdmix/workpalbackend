...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    if (request.method == HttpMethod.get) {
      final result = await billingService.listTransactionsWp(
        idToken: idToken,
        paymentType: request.uri.queryParameters['paymentType'],
    ...
    final created = await billingService.createTransactionWp(
      idToken: idToken,
      payload: body,
    );
