...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    if (request.method == HttpMethod.get) {
      final result = await commerceService.listProducts(
        idToken: idToken,
        ...
        ownerId: request.uri.queryParameters['ownerId'],
        ...
        minPrice:
            double.tryParse(request.uri.queryParameters['minPrice'] ?? ''),
        maxPrice:
            double.tryParse(request.uri.queryParameters['maxPrice'] ?? ''),
      );
    ...
    final created = await commerceService.createProduct(
      idToken: idToken,
      payload: body,
    );
