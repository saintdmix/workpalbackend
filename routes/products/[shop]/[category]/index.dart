...
Future<Response> onRequest(RequestContext context, String shop, String category) async {
  ...
  try {
    ...
    if (request.method == HttpMethod.get) {
      final result = await nriLegacyService.listShopCategoryProducts(
        idToken: idToken,
        shop: shop,
        category: category,
      );
    ...
    final result = await nriLegacyService.createShopCategoryProduct(
      idToken: idToken,
      shop: shop,
      category: category,
      payload: body,
